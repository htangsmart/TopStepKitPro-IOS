Pod::Spec.new do |s|
  s.name         = 'TopStepComKitFw'
  s.summary      = 'TopStepComKitFw module, M1 and above support xcode framworks.'
  s.version      = '1.0.2'
  s.description      = <<-DESC
  ...
  s.requires_arc = true
  s.vendored_frameworks = 'Products/TopStepComKitFw.framework', 'Rtt/persimwearSDK.framework', 'fw/flywearsdk.framework'
